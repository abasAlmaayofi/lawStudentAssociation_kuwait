...
import { FaArrowLeft, FaSnapchat } from "react-icons/fa";
    ...
    <div className="relative w-scree h-screen">
      ...
      <div className="absolute top-0 w-full h-auto bg-gray-00/30  flex flex-col items-center justify-center md:my-10 mt-20">
        <div className="flex flex-col items-center justify-center shadow-xl pb-4 px-6 shadow-black/30 bg-white/50 rounded-md md:w-[550px] w-[380px] h-auto">
          <img src={logoTransparent} alt="LSA_KU Logo" className="w-52 h-52" />
            ...
            <div className="font-TrikaRegular">
              ...
              <div className="flex w-full justify-center text-[#3384c3] md:text-xs text-[11px] flex-row-reverse gap-4  mt-4 mb-6">
                <p className="flex gap-2">
                  <Link className="underline">+965 50555505</Link>
                  <span>طلبة</span>
                </p>
                <p className="flex gap-2 border-r border-[#3384c3]/70 pr-4 mr-2">
                  <Link className="underline">+965 50555505</Link>{" "}
                  <span>طالبات</span>
                </p>
              </div>
              ...
              >
                ...
                <div className="flex flex-col gap-2 my-6 text-[#3384c3] text-[12px]">
                  <label htmlFor="email" className="tracking-wide text-right ">
                    البريد الإلكتروني
                  </label>
                  <input
                    type="text"
                ...
                <div className="flex flex-col gap-2 my-6 text-[#3384c3] text-[12px]">
                  <label htmlFor="message" className="tracking-wide text-right">
                    الرسالة
                  </label>
                  <textarea
                    type="text"
